  ...
  app.route('/api/stock-prices')
    .get(function (req, res) {
      ...
      if (req.query.stock instanceof Array) {
        if (!req.query.stock[0] || !req.query.stock[1]) return res.send('Invalid Stock Name')
        ...
        axios.get(url1)
          ...
          .then(() => findUpdate(sName1, req.query.like, req.ip))
          .then((result1) => {
            findUpdate(sName2, req.query.like, req.ip)
              .then((result2) => {
        ...
        if (!req.query.stock) return res.send('Invalid Stock Name')
